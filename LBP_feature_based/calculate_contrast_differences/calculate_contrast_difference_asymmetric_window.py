...
def save_contrast_differences_for_CASme2(window_len, kl, kr):
    rst_path = '/results/contrast_differences/CAS(ME)^2_LBP_contrast_differences' + '/' + 'window_len_' + str(window_len) + '_kl_' + str(kl) + '_kr_' + str(kr)
...
def save_contrast_difference_for_SAMM_Long_Videos(window_len, kl, kr):
    rst_path = '/results/contrast_differences/SAMM_Long_Videos_LBP_contrast_differences' + '/' + 'window_len_' + str(window_len) + '_kl_' + str(kl) + '_kr_' + str(kr)
    if not os.path.exists(rst_path):
        os.mkdir(rst_path)
